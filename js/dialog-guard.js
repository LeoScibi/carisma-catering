...
// dialog; intercepts every close attempt (explicit buttons via guardedClose(),
// ESC via the native 'cancel' event, and backdrop click) through the same
    ...
    dialogEl.insertAdjacentHTML('beforeend', `
      <div class="discard-panel">
        <div class="box">
          ...
          <div class="actions">
            <button type="button" class="secondary" data-role="keep-editing">Keep editing</button>
            <button type="button" class="danger" data-role="discard">Discard changes</button>
          </div>
        </div>
      </div>`);
