...
// Reads a range, e.g. "Ingredients!A:H". Returns array of rows (first row = header).
...
// Appends a single row to the end of a sheet/range, e.g. "Ingredients!A:H".
...
// Overwrites a fixed range, e.g. "Ingredients!A1:H1" for a header row, or a single cell/row.
